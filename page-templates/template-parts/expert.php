<section class="ftco-section ftco-no-pb">
    <div class="container">
        <div class="row justify-content-center mb-5 pb-2" id="eduhub-experiance-heading">
            <div class="col-md-8 text-center heading-section ftco-animate" id="eduhub-experiance-heading">
                <h2 class="mb-1"><?php echo esc_html(get_theme_mod('eduhub_expert_heading'));?></h2>
            </div>
        </div>
        <div class="row pb-5">
