...
<section id="eduhub-apply-image" class="ftco-section ftco-consult ftco-no-pt ftco-no-pb mt-5 mb-5" data-stellar-background-ratio="0.5">

	<div class="row justify-content-between">
		<div class="col-md-6  apply-now-img"  style="background-image: url(<?php echo esc_url($eduhub_apply_image_id);?>);">
